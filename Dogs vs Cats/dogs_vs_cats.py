...
original_dataset_dir = os.path.join('dogs-vs-cats', 'train')
...
'''
Data needs to be formatted appropriately. 
1. read images
2. decode JPEG content to RGB grid of pixels
3. convert these to floating point tensors
4. rescale the pixel values from 0-255 to between 0 and 1
'''

train_datagen = ImageDataGenerator(rescale=1./255)
test_datagen = ImageDataGenerator(rescale=1./255)

train_dir = os.path.join('cats_and_dogs_small', 'train')
validation_dir = os.path.join('cats_and_dogs_small', 'validation')
